  ...
  return <div className="application-layout">
    <form ref={formRef} className="application-form" noValidate onSubmit={submit}>
      ...
      <fieldset className={`application-step ${step === 2 ? "is-current" : ""}`}>
        ...
        <div className="step-actions"><button type="button" className="button button-secondary step-back" onClick={() => setStep(1)}>Nazad</button><button type="submit" className="button button-primary" disabled={submitting}>{submitting ? "Čuvanje prijave…" : "Pošalji prijavu"}</button></div>
      </fieldset>
