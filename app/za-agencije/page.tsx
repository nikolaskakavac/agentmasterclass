...
export default function AgenciesPage() {
  return <main><EditorialHero eyebrow="ZA AGENCIJE" title="Šalješ ceo tim?" intro="Kada ceo tim prođe istu obuku, prestaje da se dešava da svaki agent vodi razgovor na svoj način." />
    ...
    <Section className="light-section"><Container><div className="team-offer"><div><SectionHeading eyebrow="GRUPNA PONUDA" title="Obuka prilagođena timu" /><p>Za grupe od tri i više polaznika dostupan je popust, a za veće timove organizujemo termin isključivo za vašu agenciju.</p><ButtonLink href="/prijava">Prijavi tim →</ButtonLink></div></div></Container></Section>
  </main>;
}
